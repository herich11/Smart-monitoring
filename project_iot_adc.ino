...
char ssid[] = "Tselhome-7FB7";          // nama hotspot
char pass[] = "71346204";    // passord hotspot
...
void sendSensor()
{
  ...
  Serial.print(POT);
  lcd.print(0,0,"KONDISI");   LCD.setCursor(0,0); LCD.print("ADC"); LCD.setCursor(5,0); LCD.print(POT); LCD.print(" ");
